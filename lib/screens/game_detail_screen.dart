...
class GameDetailScreen extends StatelessWidget {
  ...
  void _showLogPlayDialog(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => LogPlayScreen(game: game),
      ),
    );
  }
...
class _LoanGameSheetState extends State<_LoanGameSheet> {
  ...
  void _lendGame() async {
    ...
    if (success) {
      ...
      // Refresh the game provider to update the UI
      if (context.mounted) {
